...
(function initProjectsSlider() {
    ...
    function updateSlider() {
        ...
        const centerPosition = card.offsetLeft - (swiperWindow.clientWidth / 2) + (card.clientWidth / 2);
    ...
    swiperWindow.addEventListener('touchstart', (e) => {
        startX = e.changedTouches[0].screenX;
        isDragging = true;
    }, { passive: true });

    swiperWindow.addEventListener('touchend', (e) => {
    ...
    swiperWindow.addEventListener('wheel', (e) => {
